...
export class Initial1626168675805 implements MigrationInterface {
  name = "Initial1626168675805";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "project_entity" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "shortDescription" character varying NOT NULL, "githubLink" character varying NOT NULL, "websiteLink" character varying, "imgLink" character varying, "tinyImgLink" character varying, "startDate" character varying NOT NULL, "endDate" character varying, "isHighlight" boolean, "heroImgLink" character varying, "playStoreLink" character varying, "appStoreLink" character varying, CONSTRAINT "UQ_d0bb39c7fc0bd40f20a55620474" UNIQUE ("title"), CONSTRAINT "PK_7a75a94e01d0b50bff123db1b87" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`
       ...
       insert into project_entity (title, description, "shortDescription", "githubLink", "websiteLink", "startDate", "isHighlight", "imgLink", "heroImgLink") 
         ...
         ((select id from technology_entity where title = 'TypeScript'), (select id from project_entity where title = 'TripleAGloves'));
          ...
          insert into project_entity (title, description, "shortDescription", "githubLink", "startDate", "isHighlight", "heroImgLink") 
